...
class Member implements UserInterface, \Serializable
{
     ...
     * @var integer
     *
     * @ORM\Column(name="lockerNumber", type="integer", nullable=false, options={"default"=0, "unsigned"=true})
     */
    private $lockerNumber = '0';
     ...
     * @var string
     *
     * @ORM\Column(name="sendLoginData", type="string", length=1, nullable=false, options={"default"="", "fixed"=true})
     */
     ...
     * @var binary
     *
     * @ORM\Column(name="avatarSRC", type="binary", length=16, nullable=true, options={"fixed"=true})
     */
    private $avatarSRC;
     ...
     * @var string
     *
     * @ORM\Column(name="accessionDate", type="string", length=10, nullable=false, options={"default"=""})
     */
     ...
     * @var boolean
     *
     * @ORM\Column(name="trainingCourses", type="boolean", nullable=false, options={"default"=0, "unsigned"=true})
     */
    private $trainingCourses = '0';
     ...
     * @var string
     *
     * @ORM\Column(name="isRespiratoryProtectiveEquipmentRack", type="string", length=1, nullable=false, options={"default"="", "fixed"=true})
     */
    private $isRespiratoryProtectiveEquipmentRack = '';
     ...
     * @var boolean
     *
     * @ORM\Column(name="stressExercise", type="boolean", nullable=false, options={"default"=0, "unsigned"=true})
     */
    private $stressExercise = '0';
     ...
     * Set sendLoginData
     *
     * @param string $sendLoginData
     *
     * @return Member
     */
    public function setSendLoginData($sendLoginData)
    {
     ...
     * @return string
     */
    public function getSendLoginData()
    {
    ...
    /**
     * Set isRespiratoryProtectiveEquipmentRack
     *
     * @param string $isRespiratoryProtectiveEquipmentRack
     *
     * @return Member
     */
    public function setIsRespiratoryProtectiveEquipmentRack($isRespiratoryProtectiveEquipmentRack)
    {
        $this->isRespiratoryProtectiveEquipmentRack = $isRespiratoryProtectiveEquipmentRack;

        return $this;
    }

    /**
     * Get isRespiratoryProtectiveEquipmentRack
     *
     * @return string
     */
    public function getIsRespiratoryProtectiveEquipmentRack()
    {
        return $this->isRespiratoryProtectiveEquipmentRack;
    }
     ...
     * Set stressExercise
     *
     * @param boolean $stressExercise
     *
     * @return Member
     */
    public function setStressExercise($stressExercise)
    {
        $this->stressExercise = $stressExercise;
     ...
     * @return boolean
     */
    public function getStressExercise()
    {
        return $this->stressExercise;
    }
    ...
    public function serialize()
    {
        return serialize(array(
            ...
            $this->ranks,
            $this->isRespiratoryProtectiveEquipmentRack,
            $this->g26,
            $this->stressExercise
        ));
    }
